...
if (!isset($action)) {
	...
	if ($action == 1) {
		setcookie('news_title_1', 'US growth faster than expected', time() + (86400 * 30), "/");
		setcookie('news_date_1', '25 October 2017', time() + (86400 * 30), "/");
		...
		setcookie('news_title_2', 'Wall Street: Tech firm surge pushes US markets higher', time() + (86400 * 30), "/");
		setcookie('news_date_2', '26 October 2017', time() + (86400 * 30), "/");
		# inicijalizacija kolačića
		print '
		...
		setcookie('news_title_3', 'Hotel booking sites probed by consumer watchdog', time() + (86400 * 30), "/");
		setcookie('news_date_3', '27 October 2017', time() + (86400 * 30), "/");
		# inicijalizacija kolačića
		print '
