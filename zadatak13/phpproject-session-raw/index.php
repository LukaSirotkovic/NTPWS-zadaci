...
if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
	...
	if (!empty($_SESSION['news_title_1'])) {
		print '<p><strong>' . htmlspecialchars($_SESSION['news_title_1']) . '</strong><br>
				   <time>' . htmlspecialchars($_SESSION['news_date_1']) . '</time></p>';
	}
	if (!empty($_SESSION['news_title_2'])) {
		print '<p><strong>' . htmlspecialchars($_SESSION['news_title_2']) . '</strong><br>
				   <time>' . htmlspecialchars($_SESSION['news_date_2']) . '</time></p>';
	}
	if (!empty($_SESSION['news_title_3'])) {
		print '<p><strong>' . htmlspecialchars($_SESSION['news_title_3']) . '</strong><br>
				   <time>' . htmlspecialchars($_SESSION['news_date_3']) . '</time></p>';
	}
